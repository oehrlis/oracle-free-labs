...
after the database and the `LABPDB1` PDB are opened.
...
- **10_startup_config_labpdb1.sql**  
  Basic instance startup configuration for the PDB `LABPDB1`. Executed after the
...
- Additional startup scripts can be added as needed to extend the EA demo
  environment.
