...
--------------------------------------------------------------------------------
--  Name......: 10_create_pdb_labpdb1.sql
--  Author....: Stefan Oehrli (oes) stefan.oehrli@oradba.ch
--  Editor....: Stefan Oehrli
--  Date......: 2025.11.18
--  Revision..: v1.0.0
--  Purpose...: Script to create PDB LABPDB1 from PPDB$SEED if it does not exists yet and
...
-- Begin logging ---------------------------------------------------------------
DEFINE LOG_PREFIX = '10_create_pdb_labpdb1'
...
@/opt/oracle/common/scripts/create_pdb.sql LABPDB1
