...
--------------------------------------------------------------------------------
--  Name......: 12_create_audit_policies_odbencprod.sql
--  Author....: Stefan Oehrli (oes) stefan.oehrli@oradba.ch
--  Editor....: Stefan Oehrli
--  Date......: 2026.09.03
--  Revision..: v1.0.0
--  Purpose...: Create custom local audit policies in PDB ODBENCPROD
...
-- Switch to PDB ODBENCPROD ----------------------------------------------------
PROMPT - Switch to PDB ODBENCPROD
ALTER SESSION SET CONTAINER=ODBENCPROD;

-- Begin logging ---------------------------------------------------------------
DEFINE LOG_PREFIX = '12_create_audit_policies_odbencprod'
...
-- Main ------------------------------------------------------------------------
@/opt/oracle/common/scripts/create_audit_policies.sql
