...
--------------------------------------------------------------------------------
--  Name......: 30_config_tde_odbencprod.sql
--  Author....: Stefan Oehrli (oes) stefan.oehrli@oradba.ch
--  Editor....: Stefan Oehrli
--  Date......: 2026.09.03
--  Revision..: v1.2.0
--  Purpose...: Configure TDE for ODBENCPROD using WALLET_ROOT and software
...
--              - ARCHIVELOG comes from the image default ENABLE_ARCHIVELOG=true;
--                both restarts here preserve that setting via SPFILE.
...
-- Begin logging ---------------------------------------------------------------
DEFINE LOG_PREFIX = '30_config_tde_odbencprod'
...
PROMPT ========================================================================
PROMPT == Configure TDE for ODBENCPROD ========================================
PROMPT ========================================================================
