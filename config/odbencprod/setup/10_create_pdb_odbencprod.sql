...
--------------------------------------------------------------------------------
--  Name......: 10_create_pdb_odbencprod.sql
--  Author....: Stefan Oehrli (oes) stefan.oehrli@oradba.ch
--  Editor....: Stefan Oehrli
--  Date......: 2026.09.03
--  Revision..: v1.0.0
--  Purpose...: Script to create PDB ODBENCPROD from PPDB$SEED if it does not
--              exist yet.
...
-- Begin logging ---------------------------------------------------------------
DEFINE LOG_PREFIX = '10_create_pdb_odbencprod'
...
@/opt/oracle/common/scripts/create_pdb.sql ODBENCPROD
