...
-- -----------------------------------------------------------------------------
--  Name......: 31_encrypt_ts_users_odbencprod.sql
--  Author....: Stefan Oehrli (oes) stefan.oehrli@oradba.ch
--  Editor....: Stefan Oehrli
--  Date......: 2026.09.03
--  Revision..: v1.0.0
--  Purpose...: Encrypt the USERS tablespace in PDB ODBENCPROD.
--              This is the tablespace that holds the demo data (SCOTT, TVD_HR)
--              used as the ciphertext baseline in the TDE restore
--              verification test.
...
-- Begin logging ---------------------------------------------------------------
DEFINE LOG_PREFIX = '31_encrypt_ts_users_odbencprod'
