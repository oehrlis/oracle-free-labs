...
after the database and the `ODBREPO` PDB are opened.
...
- **10_startup_config_odbrepo.sql**  
  Basic instance startup configuration for the PDB `ODBREPO`. Executed after the
